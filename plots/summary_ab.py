...
path_root_list_ab_true = [
                  '/home/billault/Documents/In_progress/mcmc/tests_cv_longer_newdata/chains_spectra_pt/mcmc_chains_spectra_edr1e-4_cov_discard_noise_sigma0.35_freeturb_abtrue_pt_1lev_swap1/',
                  ]

path_root_list_ab_bf = [
                  '/home/billault/Documents/In_progress/mcmc/tests_cv_longer_newdata/chains_spectra_pt/mcmc_chains_spectra_edr1e-4_cov_discard_noise_sigma0.35_freeturb_abbf_pt_1lev_swap1/',
                  ]

fig_prefix = 'histograms_ab_free_vs_fixed_after_burnin_'
...
for target_spec in target_spec_list:
    ...
    axs[-1].legend(
        custom_lines, 
        ['free a-b', 'fixed true a-b','fixed a-b BF','ground truth'], 
        # title="EDR",
        bbox_to_anchor=(1, 1),
        loc='upper left',
        fontsize=13
